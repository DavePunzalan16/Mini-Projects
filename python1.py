...
class Shatterdart:
  def __init__(self):
      ...
      self.init_game()
      self.brick_images = {
          'Y': pygame.image.load('bricks_icon/YELLOW.png'),
          'RD': pygame.image.load('bricks_icon/RED.png'),
          'B': pygame.image.load('bricks_icon/BLUE.png'),
          'ORNG': pygame.image.load('bricks_icon/ORANGE.png'),
          'GR': pygame.image.load('bricks_icon/GREEN.png'),
          'P': pygame.image.load('bricks_icon/PINK.png'),
          'PR': pygame.image.load('bricks_icon/PURPLE.png')
      }
  ...
  def draw_bricks(self):
      for brick in self.bricks:
          brick_image = self.brick_images[self.brick_type]
  ...
  def handle_collisions(self):
      for brick in self.bricks:
          if self.ball.colliderect(brick):
              # Assuming each brick is a tuple (pygame.Rect, brick_type)
              brick_rect, brick_type = brick
              if brick_type == 'Y':
                  self.score += 3
              elif brick_type == 'RD':
                  self.score += 5
