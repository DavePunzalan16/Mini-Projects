...
block_collision_sound = pygame.mixer.Sound('DMPassets/Explosion.wav')
...
BALL_ICON = pygame.image.load('DMPassets/ball.png')
    ...
    def handle_collisions(self):
        for brick in self.bricks:
            if self.ball.colliderect(brick):
                ...
                # Play the block collision sound effect
                block_collision_sound.play()
